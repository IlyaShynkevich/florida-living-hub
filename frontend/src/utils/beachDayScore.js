/**
 * Beach Day Score utility — decision-support logic only.
 ...
 */
export function calcBeachDayScore({
  uvIndex,
  ...
  return { score, label, explanation, warnings, positives }
}
 ...
 */
export function deriveHeatRisk(airTemperature) {
 ...
 */
export function deriveParkingDifficulty(parkingNotes) {
